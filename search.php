        ...
        <div class="card-body">
            ...
            <div class="card-deck">
              <?php 
                 ...
                 $req="select * from products where product_title like '%$search%' or product_description like '%$search%'";
                 $res=Query($req);
                 if($res->num_rows > 0):
             ...
             ?>
              <div class="alert alert-info mx-auto mt-3">Aucune produit trouvé.</div>
             <?php
                   endif;
             ?>
